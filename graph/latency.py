...
#     "Netdata (1s)":       "#d62728",
#     "X-Monitor (1s)":     "#ff7f0e",
#     "X-Monitor (1ms)":    "#2ca02c",
#     "X-Monitor (200μs)":  "#1f77b4",
# }

# # ---------- 基本ユーティリティ ----------
# def interval_label(sec: float) -> str:
#     """
#     interval(sec) を 1s / 1ms / 200μs の形式で返す。
#       1       → "1s"
#       0.001   → "1ms"
#       0.0002  → "200μs"
#     """
...
#     curves_user.append((lat_net_user, p_net_user, "Netdata (1s)"))
...
#     curves_kernel.append((lat_net_kernel, p_net_kernel, "Netdata (1s)"))
